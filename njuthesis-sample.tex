...
\begin{abstract}
  \input{section/0-abstract-zh.tex}
\end{abstract}

\begin{abstract*}
  \input{section/0-abstract-en.tex}
\end{abstract*}
...
\include{section/2-background}
\include{section/3-system}
\include{section/4-implementation}
\include{section/5-alg}
\include{section/6-evaluation}
\include{section/7-summarization}
...
\begin{acknowledgement}
  \input{section/acknoledgement.tex}
\end{acknowledgement}
